...
//   const [documentType, setDocumentType] = useState(''); // 🔥 NOVO: Tipo de documento para gerar
...
//   // 🔥 ATUALIZADO: Carregar alunos com busca inteligente
...
//         // 🔥 NOVO: Estatística por localidade
...
//   // 🔥 CORRIGIDO: Abrir detalhes do aluno
...
//   // 🔥 CORRIGIDO: Criar novo aluno
//   // 🔥 CORRIGIDO: Criar novo aluno com melhor tratamento de erro
...
//   // 🔥 NOVO: Pesquisas rápidas por série/turma
...
//                     <button 
//                       onClick={() => generateDocument('declaração')}
...
export default function App() {
  ...
  // 🔥 NOVO: Estados para controlar visibilidade dos dashboards
    ...
    <div className="container">
      <header>
        ...
        <div className="controls">
          ...
          {/* 🔥 NOVO: Botões para mostrar/ocultar dashboards */}
          <button 
